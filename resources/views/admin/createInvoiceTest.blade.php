...
<style id="style-invoice">
    ...
    *[contenteditable]:hover, *[contenteditable]:focus, td:hover *[contenteditable], td:focus *[contenteditable], img.hover { background: #DEF; box-shadow: 0 0 1em 0.5em #DEF; }
    ...
    .add { margin: -2.0em 0 0; }

    .add:hover { background: #00ADEE; }

    .cut { opacity: 0; position: absolute; top: 0; left: -2.5em; }
...
<div class="page-content">
    <div class="container-fluid">
        <form action="{{ route('addInvoice') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div style="display: flex; justify-content: flex-end; margin-bottom: 5px; margin-top: 5px; gap:5px;">
                <button type="button" class="btn btn-soft-primary waves-effect waves-light" id="exportButton">
                    Download
                </button>
                <button type="submit" class="btn btn-soft-success waves-effect waves-light">
                    Save
                </button>
                ...
                <article>
                    ...
                    <table class="meta">
                        <tr>
                            ...
                            <td><span contenteditable>{{ $invoiceNumber }}</span></td>
                        </tr>
                        <tr>
                            <th><span contenteditable>Date</span></th>
                            <td><span contenteditable>{{ $current->format('d M Y') }}</span></td>
                        </tr>
                        <tr>
                            <th><span contenteditable>Amount Due</span></th>
                            <td><span id="prefix" contenteditable>RM</span><span>0.00</span></td>
                        </tr>
                    </table>
                    <table class="inventory">
                        <thead>
                            <tr>
                                ...
                                <th><span contenteditable>Rate (RM)</span></th>
                                <th><span contenteditable>Quantity</span></th>
                                <th><span contenteditable>Price (RM)</span></th>
                            </tr>
                        </thead>
                        <tbody>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelector('form').addEventListener('submit', function () {
            // Update the hidden input fields with the latest values
            document.querySelectorAll('.inventory input[type="hidden"]').forEach(function (hiddenInput) {
                const editableSpan = hiddenInput.previousElementSibling;
                hiddenInput.value = editableSpan.textContent || editableSpan.innerText;
            });
        });
    });
</script>
...
<script>
    ...
    function generateTableRow() {
        ...
        emptyColumn.innerHTML = '<td><a class="cut">-</a><span contenteditable></span></td>' +
            '<input type="hidden" name="orderItems[][item]"></td>' +
...
<script>
    ...
    function PrintElem(elem) {
        ...
        var style = document.getElementById("style-invoice");
        if (style) {
