                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="datatable2" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr data-orderitem-id="{{ $orderItem->id }}">
                                        ...
                                        <td>{{ $orderItem->orders->order_no ?? null}}</td>
                                        <td>{{ $orderItem->orders ? $orderItem->orders->created_at->format('d M Y') : null }}</td>
                        ...
                        <span class="float-right">
                            <a href="{{ route('createOrderItem', ['project' => $project ]) }}">
