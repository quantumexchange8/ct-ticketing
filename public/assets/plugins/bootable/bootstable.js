...
'</button>'+
    '</div>';
     ...
     var saveColHtml = '<div class=" pull-right" style="">'+
...
function rowEdit(but) {
    ...
    IterarCamposEdit($cols, function($td) {  //itera por las columnas
        ...
        // } else {
        //     // Otherwise, create a regular text input
        //     var input = '<input class="form-control input-sm" value="' + cont + '">';
        // }

        // // Check if content is 'No Image Available' or an image tag
        // if (cont.trim() === 'No image available' || cont.trim().startsWith('<img src')) {
        //     // If 'No Image Available' or an image tag, create a file input for updating the image
        //     var input = '<input type="file" id="fileInput" class="form-control input-sm">';
        // } else {
        //     // Otherwise, create a regular text input
        //     var input = '<input class="form-control input-sm" value="' + cont + '">';
        // }
